...
@Route(value = "amla-merchant/approval", layout = MainLayout.class)
public class ApprovalAMLAMerchantView extends VerticalLayout {
        ...
        public ApprovalAMLAMerchantView(CustomRule customRule,
