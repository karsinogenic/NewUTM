...
@Route(value = "amla-merchant-syariah/approval", layout = MainLayout.class)
public class ApprovalAMLAMerchantSyariahView extends VerticalLayout {
        ...
        public ApprovalAMLAMerchantSyariahView(CustomRule customRule,
                ...
                List<AmlaMerchantRuleResult> ruleResults = this.amlaRuleResultRepository
                                .findByIsSent(true);
                ...
                crud.getGrid().addColumn(hasil -> hasil.getReviewBy()).setHeader("Review By").setKey("review1")
                                .setSortable(true).setAutoWidth(true);
                crud.getGrid().addColumn(hasil -> hasil.getMerchNumber()).setHeader("MID").setKey("mid1")
                                .setSortable(true)
                                .setAutoWidth(true);
                crud.getGrid().addColumn(hasil -> hasil.getMerchLocalName()).setHeader("Merchant Name")
                                .setKey("merchname1")
                                .setSortable(true).setAutoWidth(true);
                ...
                crud.getGrid().addColumn(hasil -> NumberFormat.getNumberInstance(Locale.US).format(hasil.getTotalTrx()))
                                ...
                                .setSortable(true).setAutoWidth(true);
                crud.getGrid().addColumn(hasil -> hasil.getFrequency()).setHeader("Freq").setKey("freq1")
                                .setSortable(true)
                                .setAutoWidth(true);
