...
@Route(value = "amla-merchant/detail", layout = MainLayout.class)
public class DetailAMLAMerchantView extends VerticalLayout implements HasUrlParameter<String> {
    ...
    AmlaMerchantRuleResult ruleResultHist = null;
    ...
    public void setParameter(BeforeEvent event, String parameter) {
        ...
        if (param1[0].contains("SK")) {
            ...
            query += "MENYIMPANG_A\" ";
            tableHist = "cronos_menyimpang_a_detail_trx_6m";
        ...
        AmlaMerchantRuleResult ruleResult = this.amlaRuleResultRepository.findById(param1[2]).get();
        ...
        while (jsonData.keys().hasNext()) {
            ...
            String doubleKey[] = { "avg", "trx", "Amount", "total", "creditLimit", "limit" };
        ...
        HorizontalLayout txn_btn_combo = new HorizontalLayout(txn_history, txn_summary);
    ...
    private Dialog makeDialogTxnSummary(AmlaMerchantRuleResult rrHist) {
        Dialog dialog = new Dialog();
        dialog.setWidthFull();
    ...
    private Dialog makeDialogTxnHistory(AmlaMerchantRuleResult rrHist) {
        Dialog dialog = new Dialog();
        dialog.setWidthFull();
    ...
    public DetailAMLAMerchantView(JdbcQueryService jdbcQueryService,
            AmlaMerchantRuleResultRepository amlaRuleResultRepository,
    ...
    private Button createSaveButton(Dialog dialog, AmlaMerchantRuleResult ruleResult) {
