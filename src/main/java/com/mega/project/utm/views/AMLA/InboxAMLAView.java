...
@Route(value = "amla/inbox", layout = MainLayout.class)
public class InboxAMLAView extends VerticalLayout {
        ...
        public InboxAMLAView(CustomRule customRule, AmlaRuleResultRepository amlaRuleResultRepository,
                        ...
                        if (reOptional.getLockedBy() == null) {
                                ...
                                if (reOptional.getLockedBy().equals(current_user)) {
                                        ...
                                        newNotification = myNotification
                                                        .error("data sedang dikerjakan oleh user "
                                                                        + reOptional.getLockedBy());
                ...
                // crud.addToolbarComponent(detail);
                detail.setEnabled(false);

                crud.addItemClickListener(event -> {
                        try {
                                // System.out.println(Id != event.getItem().getId());
