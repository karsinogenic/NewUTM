...
@Route(value = "amla-merchant/inbox", layout = MainLayout.class)
public class InboxAMLAMerchantView extends VerticalLayout {
    ...
    public InboxAMLAMerchantView(CustomRule customRule,
