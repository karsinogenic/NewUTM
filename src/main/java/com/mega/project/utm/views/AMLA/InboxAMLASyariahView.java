...
@PermitAll
@PageTitle("AMLA Syariah Inbox")
@Route(value = "amla-syariah/inbox", layout = MainLayout.class)
public class InboxAMLASyariahView extends VerticalLayout {
        ...
        public InboxAMLASyariahView(CustomRule customRule, AmlaRuleResultRepository amlaRuleResultRepository,
