...
@PermitAll
@PageTitle("AMLA Merchant")
@Route(value = "amla-merchant", layout = MainLayout.class)
public class MainAMLAMerchantView extends VerticalLayout {
        ...
        public MainAMLAMerchantView(JdbcQueryService jdbcQueryService) {
                ...
                String query = "select count(*),a.triggered_rule from \"AMLA_MERCHANT_RULE_RESULT\" a where \"post_date\" = \'"
                                + ldt.toString() + "\' group by a.triggered_rule";
                String query1 = "select count(*),a.triggered_rule,a.is_approved,a.is_sent from \"AMLA_MERCHANT_RULE_RESULT\" a where \"post_date\" = \'"
                                + ldt.toString()
                                + "\' group by a.triggered_rule,a.is_approved,a.is_sent order by a.triggered_rule,a.is_approved desc";

                String query2 = "select count(*),a.triggered_rule,a.is_approved,a.is_sent from \"AMLA_MERCHANT_RULE_RESULT\" a group by a.triggered_rule,a.is_approved,a.is_sent order by a.triggered_rule,a.is_approved desc";

                String query3 = "select count(*),a.triggered_rule from \"AMLA_MERCHANT_RULE_RESULT\" a group by a.triggered_rule";
