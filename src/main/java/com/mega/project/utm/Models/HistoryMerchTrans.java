...
@Entity
@Table(name = "HISTORY_MSP_QR_CODE_DATA_HISTORY")
@Data
@NoArgsConstructor
@AllArgsConstructor
public class HistoryMerchTrans {
    ...
    // @OneToOne
    // @JoinColumn(name = "Key_No", referencedColumnName = "Key_No", insertable =
    // false, updatable = false)
    // private HistoryMemo historyMemo;
